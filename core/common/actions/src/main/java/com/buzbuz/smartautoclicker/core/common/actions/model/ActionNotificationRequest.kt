 ...
 */
<<<<<<<< HEAD:core/smart/domain/src/main/java/com/nooblol/smartnoob/core/domain/model/SmartActionExecutor.kt
...
>>>>>>>> upstream/master:core/common/actions/src/main/java/com/buzbuz/smartautoclicker/core/common/actions/model/ActionNotificationRequest.kt
    val actionId: Long,
    val eventId: Long,
    val title: String,
    val message: String,
