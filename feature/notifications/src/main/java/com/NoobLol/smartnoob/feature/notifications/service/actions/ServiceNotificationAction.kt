 ...
 */
package com.NoobLol.smartnoob.feature.notifications.service.actions
...
internal enum class ServiceNotificationAction(val intentAction: String) {
    PLAY_AND_HIDE("com.NoobLol.smartnoob.PLAY_AND_HIDE"),
    PAUSE_AND_SHOW("com.NoobLol.smartnoob.PAUSE_AND_SHOW"),
    SHOW("com.NoobLol.smartnoob.SHOW"),
    HIDE("com.NoobLol.smartnoob.HIDE"),
    STOP_SCENARIO("com.NoobLol.smartnoob.STOP_SCENARIO");
