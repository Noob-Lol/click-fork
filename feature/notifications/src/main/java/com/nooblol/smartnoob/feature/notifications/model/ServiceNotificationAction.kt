...
private fun ServiceNotificationAction.getBroadcastAction(): String =
    when (this) {
        ServiceNotificationAction.Play -> "com.nooblol.smartnoob.PLAY"
        ServiceNotificationAction.Pause -> "com.nooblol.smartnoob.PAUSE"
        ServiceNotificationAction.Show -> "com.nooblol.smartnoob.SHOW"
        ServiceNotificationAction.Hide -> "com.nooblol.smartnoob.HIDE"
        ServiceNotificationAction.Stop -> "com.nooblol.smartnoob.STOP"
