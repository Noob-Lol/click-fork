 ...
 */
package com.NoobLol.smartnoob.feature.dumb.config.domain

import android.content.Context
import com.NoobLol.smartnoob.feature.dumb.config.R
import com.NoobLol.smartnoob.feature.dumb.config.data.getClickPressDurationConfig
import com.NoobLol.smartnoob.feature.dumb.config.data.getClickRepeatCountConfig
import com.NoobLol.smartnoob.feature.dumb.config.data.getClickRepeatDelayConfig
import com.NoobLol.smartnoob.feature.dumb.config.data.getDumbConfigPreferences
import com.NoobLol.smartnoob.feature.dumb.config.data.getPauseDurationConfig
import com.NoobLol.smartnoob.feature.dumb.config.data.getSwipeDurationConfig
import com.NoobLol.smartnoob.feature.dumb.config.data.getSwipeRepeatCountConfig
import com.NoobLol.smartnoob.feature.dumb.config.data.getSwipeRepeatDelayConfig
